  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center relative overflow-hidden bg-slate-950">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl glass animate-slide-up z-10 relative">
        <Suspense fallback={<div className="h-64 flex items-center justify-center"><div className="h-16 w-16 rounded-full border-4 border-indigo-500/20 border-t-indigo-500 animate-spin"></div></div>}>
          <LoginForm />
        </Suspense>
      </div>
