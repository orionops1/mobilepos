...
async function main() {
  ...
  const customers = await Promise.all([
    prisma.customer.upsert({
      where: { tenantId_mobile: { tenantId: tenant.id, mobile: '0771234567' } },
      update: {},
      create: {
        name: 'Nimal Perera',
        mobile: '0771234567',
        alternateMobile: '0772345678',
    ...
    prisma.customer.upsert({
      where: { tenantId_mobile: { tenantId: tenant.id, mobile: '0767891234' } },
      update: {},
      create: {
    ...
    prisma.customer.upsert({
      where: { tenantId_mobile: { tenantId: tenant.id, mobile: '0754567890' } },
      update: {},
      create: {
        name: 'Kamal Silva',
        mobile: '0754567890',
        alternateMobile: '0755678901',
